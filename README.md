...
- 이의정 : 이번 프로젝트를 통해 웹 크롤링을 처음 접해보았고, 이 작업이 일상에서도 매우 유용하게 활용될 수 있는 기술이라는 점을 느꼈습니다. 앞으로 웹 크롤링과 데이터 수집 분야를 더 깊이 공부해보고 싶다는 생각이 들었습니다. 또한 팀 프로젝트를 진행하면서 개인 프로젝트와 달리 Git을 사용할 때 충돌(conflict) 이 자주 발생한다는 점을 직접 경험했습니다. 그 과정에서 협업 시 코드 관리의 중요성을 배울 수 있었고, 제 부족한 부분도 명확히 인식하게 되었습니다. 짧은 시간이었지만 좋은 팀원분들을 만나 함께 노력하며 프로젝트를 성공적으로 마무리할 수 있었습니다. 모두 고생 많으셨습니다. 감사합니다. 
